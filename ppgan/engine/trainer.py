...
class Trainer:
    def __init__(self, cfg):
        ...
        self.output_dir = os.path.join(cfg.output_dir, str(cfg.model.name) + self.timestamp)
    ...
    def test(self):
        ...
        for i, data in enumerate(self.test_dataloader):
            ...
            if i % self.log_interval == 0:
                print('Test iter: [%d/%d]' % (i, len(self.test_dataloader)))
    ...
    def save(self, epoch, name='checkpoint', keep=1):
        ...
        if keep > 0:
            try:
                ...
                print('remove old checkpoints error: {}'.format(e))
